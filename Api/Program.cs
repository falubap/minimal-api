...
//Geracao de token para administrador
...
{
    var validacao = new ErrosDeValidcao
    {
    ...
    if (string.IsNullOrEmpty(administradorDTO.Senha))
        validacao.Mensagens.Add("A senha não pode estar vazia");
...
//Consultar administrador pelo ID
...
ErrosDeValidcao validaDTO(VeiculoDTO veiculoDTO)
{
    var validacao = new ErrosDeValidcao
    {
        Mensagens = new List<string>()
